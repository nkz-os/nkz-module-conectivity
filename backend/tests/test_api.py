"""
Tests for Connectivity Backend
"""
...
class TestAPI:
    ...
    def test_docs_available(self, client):
        ...
        response = client.get("/api/connectivity/docs")
        # Should return HTML or redirect
        assert response.status_code in [200, 307]
    
    def test_openapi_schema(self, client):
        """Test OpenAPI schema is generated."""
        response = client.get("/api/connectivity/openapi.json")
        assert response.status_code == 200
    ...
    def test_list_data_requires_auth(self, client):
        ...
        response = client.get("/api/connectivity/data")
